...
func (c *userService) SendMessage(ctx context.Context, in *MessageRequest, opts ...client.CallOption) (*MessageResponse, error) {
	req := c.c.NewRequest(c.name, "User.SendMessage", in)
...
func (h *userHandler) SendMessage(ctx context.Context, in *MessageRequest, out *MessageResponse) error {
	return h.UserHandler.SendMessage(ctx, in, out)
}
